...
Licensed Work: instrumenta (the "Software")
The Licensed Work is (c) 2026 Andrew Molyuk

Additional Use Grant: You may use, copy, modify, and self-host the Licensed
Work for any purpose, including production use, **except** to offer it —
in original or modified form — to third parties as a hosted or managed
service that runs autonomous coding agents on their behalf (picking up
tasks, implementing or fixing them, and opening pull requests against a
target codebase) that competes with instrumenta. Internal use within
your own organization, including running the Software against your own or
your clients' codebases without reselling the Software itself as a
